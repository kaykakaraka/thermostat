...
describe(Thermostat,() => {
  ...
  it('returns medium usage as the energy usage when the thermostat is turned up to 25',() => {
    const thermostat = new Thermostat();
    for (let i = 0 ; i < 5 ; i++) {
      thermostat.up();
    }
  ...
  it('returns high usage as the energy usage when the thermostat is turned up to 26',() => {
    const thermostat = new Thermostat();
    thermostat.setPowerSavingMode(false);
    for (let i = 0 ; i < 6 ; i++) {
      thermostat.up();
  ...
  it('returns low usage for 17 degrees',() => {
    const thermostat = new Thermostat();
    for (let i = 0 ; i < 3 ; i++) {
      thermostat.down();
    }
